public abstract class SkipList<T extends Comparable<T>> {
    ...
    public static final int MAX_LEVEL = 3; // Number of levels in the skip list
    public int level; // Current level of the skip list
    public SkipListNode<T> header; // Header node
